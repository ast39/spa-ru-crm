...
class Icons {
    ...
    const LOGIN         = 'bi bi-box-arrow-in-left';      // меню - вход
    const REGISTER      = 'bi bi-card-checklist';         // меню - регистрация
    const DEMO          = 'bi bi-door-open';              // меню - дэмо

    const EMPLOYEES     = 'bi bi-people-fill';            // меню - сотрудники
    const PRICE         = 'bi bi-tags';                   // меню - прайс
    const REPORTS       = 'bi bi-list-task';              // меню - отчеты
    const SHIFT         = 'bi bi-calendar2-date';         // меню - смена
