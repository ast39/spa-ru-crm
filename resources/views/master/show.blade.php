        ...
        <div class="card-body bg-light">
            ...
            <form method="post" action="{{ route('dict.master.destroy', $master->id) }}">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    ...
                    <button type="submit" title="Delete" onclick="return confirm('{{ __('"Вы уверены, что хотите убрать пользователя с должности мастера?') }}')" class="btn btn-danger me-1 rounded">{{ __('Удалить') }}</button>
                </div>
            </form>
        </div>
