            ...
            <table class="table table-striped table-borderless">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">{{ number_format($seance->service->price, 2, '.', ' ') }} {{ __('р.') }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-end">{{ number_format($seance->master_profit, 2, '.', ' ') }} {{ __('р.') }}</td>
                    </tr>
                    <tr>
                        <th class="text-start">{{ __('Заработок компании') }}</th>
                        <td class="text-end">{{ number_format($seance->total_price_with_sale - $seance->admin_profit - $seance->master_profit, 2, '.', ' ') }} {{ __('р.') }}</td>
                    </tr>
