            ...
            <form method="post" action="{{ route('shift.program.update', $seance->seance_id) }}">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                        ...
                        {{-- Внесено наличными --}}
                        <div class="mb-3">
                            <label for="sale" class="form-label">{{ __('Оплачено наличными') }}</label>
                            <div class="input-group">
                        ...
                        {{-- Внесено картой --}}
                        <div class="mb-3">
                            <label for="sale" class="form-label">{{ __('Оплачено картой') }}</label>
                            <div class="input-group">
                        ...
                        {{-- Внесено переводом --}}
                        <div class="mb-3">
                            <label for="sale" class="form-label">{{ __('Оплачено переводом') }}</label>
                            <div class="input-group">
                        ...
                        <div class="mb-3">
                            <label for="sale" class="form-label">{{ __('Оплачено сертификатом') }}</label>
                            <div class="input-group">
