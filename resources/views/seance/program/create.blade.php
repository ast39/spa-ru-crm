            ...
            <form method="post" action="{{ route('shift.program.store') }}">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="program_id" id="program_id" class="form-select form-control">
                                @foreach($programs as $program)
                                    <option data-price="{{ $program->price }}" {{ (request()->program_id ?? 0) == $program->program_id ? 'selected' : '' }} value="{{ $program->program_id }}">{{ $program->title }}</option>
                                @endforeach
                            </select>
                            @error('program_id')
                        ...
                        {{-- Начало программы --}}
                        <div class="mb-3">
                            <label for="open_time" class="form-label required">{{ __('Начало программы') }}</label>
                        ...
                        {{-- Окончание программы --}}
                        <div class="mb-3">
                            <label for="close_time" class="form-label required">{{ __('Окончание программы') }}</label>
                            <div class="mmot-filterline__one mmot-inputwithico-left" data-input_clear_content>
                                <svg class="mmot-inputwithico-left__ico"><use xlink:href="#site-calendar"></use></svg>
                    ...
                    <div class="tab-pane fade" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input
                                    type="text"
                                    class="form-control text-center percent-input disabled cover_master_percent"
                                    disabled
                                    id="cover_master_percent"
                                    name="cover_master_percent"
                                    value="{{ old('cover_master_percent', 40) }}"
                                    readonly
                                    data-min="1"
                                    data-max="50"
                                    data-step="1"
                    ...
                    <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-end percent-input" id="handle_price" name="handle_price" value="{{ round($programs[0]->price) }}" readonly />
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-end percent-input" id="total" name="total" value="{{ old('total', round($programs[0]->price)) }}" readonly />
                                <span class="input-group-text">{{ __('руб.') }}</span>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function recalculate() {
                // Базовая цена
                const selectedOption = $('#program_id').find('option:selected');
